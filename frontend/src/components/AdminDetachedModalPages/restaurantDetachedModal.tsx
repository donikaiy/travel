...
import {useGetAllCountriesWithCities} from "@/hooks/useCountry.ts";
import React from "react";
import TableCellViewer from "../TableCellViewer/tableCellViewer";
import {Button} from "@/components/ui/button.tsx";
import {MapPlusIcon, PlusIcon} from "lucide-react";
import SelectCity from "@/components/SelectCity/selectCity.tsx";
...
const RestaurantDetachedModal = ({mode, row}: RestaurantModalProps) => {
...
export default RestaurantDetachedModal;

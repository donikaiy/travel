...
import {useDeleteCityById, useGetAllCities} from "@/hooks/useCities";
import AdminDataTable from "@/components/AdminDataTable/adminDataTable.tsx";
import CityDetachedModal from "@/components/AdminDetachedModalPages/cityDetachedModal.tsx";
            ...
            cell: ({row}) => (
                <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent align="end"
                        ...
                        <CityDetachedModal row={row.original} mode="edit" />

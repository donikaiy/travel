import {useDeleteAttractionById, useGetAllAttractions} from "@/hooks/useAttractions.ts";
...
import AttractionDetachedModal from "@/components/AdminDetachedModalPages/attractionDetachedModal.tsx";
            ...
            cell: ({row}) => (
                <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent align="end"
                        ...
                        <AttractionDetachedModal row={row.original} mode="edit"/>
    ...
    return (
        <>
            <AdminDataTable breadcrumbPage="Attractions" columns={columns} data={memoizedData} createButton={
                <AttractionDetachedModal mode="create" />
            }/>
        </>
    )
}

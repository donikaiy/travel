...
import {useDeleteRestaurantById, useGetAllRestaurants} from "@/hooks/useRestaurants.ts";
import {RestaurantWithRating} from "@/types/restaurant";
import AdminDataTable from "@/components/AdminDataTable/adminDataTable.tsx";
import RestaurantDetachedModal from "@/components/AdminDetachedModalPages/restaurantDetachedModal.tsx";
...
const AdminRestaurants = () => {
            ...
            cell: ({row}) => (
                <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent align="end"
                        ...
                        <RestaurantDetachedModal row={row.original} mode="edit"/>
    ...
    return (
        <AdminDataTable breadcrumbPage="Restaurants" columns={columns} data={memoizedData} createButton={
            <RestaurantDetachedModal mode="create"/>
        }/>
    )
}
